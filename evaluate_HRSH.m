function evaluation_info=evaluate_HRSH(XTrain,YTrain,LTrain,XTest,YTest,LTest,Lc,hubid,param)
    ...
    % training
    [B,XW,YW] = train_HRSH(XTrain,YTrain,LTrain,NLTrain,Lc,hubid,param);
